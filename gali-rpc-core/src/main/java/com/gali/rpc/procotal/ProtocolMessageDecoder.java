...
public class ProtocolMessageDecoder {
    ...
    public static ProtocolMessage<?> decode(Buffer buffer) throws IOException {
        ...
        switch (messageTypeEnum) {
            case REQUEST:
                GaliRpcRequest request = serializer.deserialize(bodyBytes, GaliRpcRequest.class);
                return new ProtocolMessage<>(header, request);
            case RESPONSE:
                GaliRpcResponse response = serializer.deserialize(bodyBytes, GaliRpcResponse.class);
